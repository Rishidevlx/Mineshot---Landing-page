                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 mb-5 mb-md-0 order-1 order-md-0">
                        <div class="footer-widget text-center">
                            <div class="logo mr-bottom-55">
                                <a href="index.php" class=""><img src="assets/img/mineshot/mineshot-logo.png"
                                        alt="logo"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 mb-5 mb-md-0">
                        <div class="footer-widget text-md-end">
                            <div class="footer-nav">
                                <ul>
                                    <li class="menu-item"><a href="projects.php">Production Hub</a></li>
                                    <li class="menu-item"><a href="projects.php">Photography</a></li>
                                    <li class="menu-item"><a href="projects.php">Videography</a></li>
                                    <li class="menu-item"><a href="projects.php">Editing & CG</a></li>
                                    <li class="menu-item"><a href="projects.php">Music Works</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-inner">
                <div class="copyright">
                    <p><a href="index.php">Mineshot Production Hub</a> , All Rights
                        Reserved & Designed by <a href="https://genzneuralx.com" style="color:#d3bc7e">Genz Neuralx</a></p>
                </div>
