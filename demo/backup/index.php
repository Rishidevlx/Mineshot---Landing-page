...
<main class="wrapper">
        ...
        <div class="swiper-container wptb-swiper-slider-two">
            ...
            <div class="swiper-wrapper">
                        ...
                        <div class="wptb-slider--inner">
                            ...
                            <div class="wptb-heading">
                                <div class="wptb-item--inner">
                                    <h1 class="wptb-item--title">Production House</h1>
                ...
                <div class="swiper-slide">
                    <div class="wptb-slider--item">
                        <div class="wptb-slider--image"
                            style="background-image: url('assets/img/mineshot/banner-3.jpg');">
                        </div>
                        <div class="wptb-slider--inner">
                            <!-- Layer Image -->
                            <div class="wptb-item-layer wptb-item-layer-one">
                            ...
                            <div class="wptb-heading">
                                <div class="wptb-item--inner">
                                    <h1 class="wptb-item--title">Photography</h1>
                ...
                <div class="swiper-slide">
                    <div class="wptb-slider--item">
                        ...
                        <div class="wptb-slider--inner">
                            ...
                            <div class="wptb-heading">
                                <div class="wptb-item--inner">
                                    <h1 class="wptb-item--title">Videography</h1>
    ...
    <!-- Services -->
    <section class="wptb-services-one" id="expertise" style="scroll-margin-top: 80px;">
            ...
            <div class="wptb-heading">
                <div class="wptb-item--inner">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <h6 class="wptb-item--subtitle"><span>01 //</span> What We Do Best</h6>
                            <h1 class="wptb-item--title">Our Creative
                                <span>Expertise</span>
                            </h1>
                        </div>
                    ...
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                ...
                                <h4 class="wptb-item--title mb-0">Production House</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                ...
                                <h4 class="wptb-item--title mb-0">Photography Events</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                ...
                                <h4 class="wptb-item--title mb-0">Videography Events</h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- About Kimono -->
    <section class="wptb-about-two bg-transparent pt-0" id="about" style="scroll-margin-top: 80px;">
        <div class="container">
            <div class="wptb-heading">
                <div class="wptb-item--inner">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <h6 class="wptb-item--subtitle"><span>02 //</span> Turning Ideas Into Powerful Visuals
                            </h6>
                            <h1 class="wptb-item--title">About <span>Mineshot</span> Production Hub</h1>
                        </div>
                        <div class="col-lg-5 text-lg-end">
                            <div class="wptb-item--button">
                                <a href="#enquiry" class="btn btn-two creative text-uppercase">
                                    <span class="btn-wrap">
        ...
        <div class="wptb-text-marquee1 wptb-slide-to-left">
            <div class="wptb-item--container">
                <div class="wptb-item--inner">
                    ...
                    <h4 class="wptb-item--text text-outline">
                        <span class="wptb-text-backdrop">House</span>
                        <span class="wptb-item-layer both-version position-relative">
                            <img src="assets/img/more/star.png" alt="img">
                            <img src="assets/img/more/star-dark.png" alt="img">
                        </span>
    ...
    <!-- Albums -->
    <section class="wptb-album-one home-services-sec" id="services">
        <div class="container-full">
            <div class="wptb-heading mb-0">
                <div class="wptb-item--inner text-center">
                    <h6 class="wptb-item--subtitle"><span>03 //</span> Photography & Videography Services</h6>
                    <h1 class="wptb-item--title lg">Capturing Every Detail with <span>Creativity</span></h1>
                </div>
            </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/mineshot/service-1.jpg" alt="img">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/mineshot/service-2.jpg" alt="img">
                                </div>

                                <div class="wptb-item--holder">
                                    <div class="wptb-item--meta">
                                        <h4><a href="#">Engagement Photography</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/mineshot/service-3.jpg" alt="img">
                                </div>

                                <div class="wptb-item--holder">
                                    <div class="wptb-item--meta">
                                        <h4><a href="#">Housewarming Photography</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/mineshot/service-4.jpg" alt="img">
                                </div>

                                <div class="wptb-item--holder">
                                    <div class="wptb-item--meta">
                                        <h4><a href="#">Birthday Photography</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="grid-item">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/mineshot/service-5.jpg" alt="img">
                                </div>

                                <div class="wptb-item--holder">
                                    <div class="wptb-item--meta">
                                        <h4><a href="#">Corporate Event Photography</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Our Portfolio -->
    <section class="wptb-project pt-0" id="projects" style="scroll-margin-top: 80px;">
        <div class="container">
            <div class="wptb-heading">
                <div class="wptb-item--inner text-center">
                    <h6 class="wptb-item--subtitle"><span>04//</span> Our Portfolio</h6>
                    <h1 class="wptb-item--title"> A Showcase of Our <span>Creative Work</span></h1>
                </div>
            </div>
                ...
                <div class="grid gutter-10 clearfix">
                    ...
                    <div class="row">
                        <div class="grid-item col-md-4">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/1.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-item col-md-4">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/2.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-item col-md-4">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/3.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-item col-md-8">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/4.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-item col-md-8">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/5.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid-item col-md-4">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="assets/img/projects/4/6.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Agency Experience -->
    <section class="wptb-agency-experience bg-image pb-xl-0"
        style="background-image: url('assets/img/background/bg-13.jpg');">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner">
                            <h1 class="wptb-item--title lg mb-5">Why Choose <br> <span class="text-outline">Mineshot
                                    ?</span></h1>
                ...
                <div class="col-lg-4 ps-lg-5 mt-5">
                    <div class="wptb-counter1 style1 mr-bottom-100 wow skewIn">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--holder d-flex align-items-center">
                                <div class="wptb-item--value"><span class="odometer" data-count="500"></span><span
                    ...
                    <div class="wptb-counter1 style1 mr-bottom-100 wow skewIn">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--holder d-flex align-items-center">
                                <div class="wptb-item--value"><span class="odometer" data-count="490"></span><span
                                        class="suffix">+</span></div>
                                <br>
    ...
    <!-- Contact -->
    <section class="wptb-contact-form style1" id="contact">
                        ...
                        <div class="wptb-icon-box1 wow fadeInLeft">
                            <div class="wptb-item--inner flex-start">
                                ...
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description">simbhu@mineshot.in</p>
                        ...
                        <div class="wptb-icon-box1 wow fadeInLeft">
                            <div class="wptb-item--inner flex-start">
                                ...
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description">No.35 4th Cross street, Indranagar, Adyar, Chennai
                                        600020</p>
                                </div>
                            </div>
                        </div>
