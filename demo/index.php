...
<main class="wrapper">
                ...
                <div class="wptb-item--inner">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <h1 class="wptb-item--title">Our Creative Expertise
                            </h1>
                        </div>
                    ...
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                ...
                                <h4 class="wptb-item--title mb-0">Production Hub</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 ps-0 wow fadeInLeft">
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                <h4 class="wptb-item--title mb-0">Commercial Advertising Photography</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 ps-0 wow fadeInLeft">
                    <div class="wptb-icon-box5 mb-3">
                        <div class="wptb-item--inner">
                            ...
                            <div class="wptb-item--holder">
                                <h4 class="wptb-item--title mb-0">Commercial Advertising Videography</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-full">
            <div class="wptb-heading mb-0">
                <div class="wptb-item--inner text-center">
                    <h6 class="wptb-item--subtitle">Photography & Videography Services</h6>
                    <h1 class="wptb-item--title lg">Capturing Every Detail with Creativity</h1>
                </div>
            </div>
    ...
    <div class="wptb-instagram--gallery top-footer-sec">
        ...
        <div class="wptb-item--button">
            <a class="btn btn-two" href="https://www.instagram.com/mineshotproductionhub">
                <span class="btn-wrap">
